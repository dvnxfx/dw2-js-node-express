...
document.write(`<p>Exibindo um elemento do array através do indíce:</p>`)
document.write(`<p>${products[3]}</p>`)

document.write(`<p>Percorrendo um array através do forEach</p>`)
products.forEach(produto => {        // função anônima com um único parâmetro
  document.write(`<p>${produto}</p>`);
});

document.write(`<p>Mostrando os indíces e valores com forEach:</p>`);
